        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <Link href="/" className="flex items-center gap-2 cursor-pointer group">
                ...
                <div className="flex flex-col justify-center">
                    <div className={`text-xl md:text-2xl font-serif font-black tracking-tight leading-none transition-colors duration-300 ${textColor}`}>
                        CoffeeMaker<span className="text-gold-500">Pro</span>
                    </div>
                    <span className={`text-[9px] md:text-[10px] tracking-widest uppercase font-bold text-coffee-600 hidden sm:block`}>Tienda Oficial</span>
                </div>
            </Link>
