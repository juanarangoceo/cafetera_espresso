...
import { Droplets, Wind, Coffee, Shield } from 'lucide-react';
...
// --- DATA: Gallery Items ---
// Note: We need to use React.createElement or similar to store components in data file if we want them to be serializable,
// but for Server Components -> Client Components passing, it's easeir if data is just data.
// However, since we are doing manual prop passing or import, we can keep JSX if file is .tsx.
// Let's keep this file as .tsx to support the icons.
